...
import com.example.auth.entity.Authorization;
import com.example.auth.repo.AuthorizationRepository;
import com.example.auth.token.PhonePasswordAuthenticationToken;
import com.example.auth.token.PhonePasswordAuthenticationTokenMixin;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        ...
        this.objectMapper.addMixIn(PhonePasswordAuthenticationToken.class, PhonePasswordAuthenticationTokenMixin.class);
    }
